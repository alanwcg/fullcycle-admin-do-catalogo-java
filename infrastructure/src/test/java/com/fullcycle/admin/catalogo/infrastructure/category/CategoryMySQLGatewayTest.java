...
public class CategoryMySQLGatewayTest {
  ...
  @Test
  public void givenAnInvalidCategoryID_whenTryToDeleteIt_thenShouldBeOk() {
    Assertions.assertEquals(0, categoryRepository.count());
  ...
  @Test
  public void givenAPrePersistedCategoryAndAValidCategoryID_whenCallsFindById_thenShouldReturnCategory() {
    final var expectedName = "Filmes";
    final var expectedDescription = "A categoria mais assistida";
    final var expectedIsActive = true;
  ...
  public void givenPrePersistedCategoriesAndMaisAssistidaAsTerms_whenCallsFindAllAndTermsMatchsCategoryDescription_thenShouldReturnPaginated() {
    ...
    final var series =
        Category.newCategory("Séries", "Uma categoria assistida", true);
